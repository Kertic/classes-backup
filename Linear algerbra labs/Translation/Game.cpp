...
bool cGame::InitializeGame()
{
	...
	ground.position=D3DXVECTOR3(0.0,0.0,0.0);
	...
	// create box 1  by calling CreateCube(..,..),  texturefile is "Crate.jpg"
	box1.CreateCube(Device,"Crate.jpg");
	// set box 1  position at (-30,20,-30)
	box1.position=D3DXVECTOR3(-30.0,20.0F,-30.0F);
	// set box 1 constant velocity to (20,10,10) m/s
	box1.velocity=D3DXVECTOR3(20.0,20.0F,0.0F);
	...
	pillar1.CreatePillar(Device,-5.0f,0.0f,-1.0f,D3DX_PI*0.5F);

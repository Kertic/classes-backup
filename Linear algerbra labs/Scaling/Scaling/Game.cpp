...
bool RenderFrame()
{
	...
	// render box1 by calling Render(theDevice)
	box1.Render(Device);
	// render box2 by calling Render(theDevice)
	box2.Render(Device);
	// render the 5 pillars by calling Render(theDevice)
...
INT WINAPI WinMain (HINSTANCE hInstance, HINSTANCE hPrevInst,LPSTR lpCmdLine, int nShowCmd)
{
 ...
 game=new cGame();
  /* Create window */
 game->CreateGameWindows(hInstance," Linear Algebra Tutorial #2 : Scaling simulation");

...
#pragma region Draw Grid
		...
		ShaderViewTranslationMatrix = IdentityMatrix();
		ShaderViewTranslationMatrix.c4 = cameraTranslationIn;
		ShaderViewTranslationMatrix.a4 = cameraTranslationRight;
		ShaderProjectionMatrix = ProjectionMatrix(90,((float)SCREEN_WIDTH /(float)SCREEN_HEIGHT ), 0.1f, 10.0f);
...
#pragma region Back face
		...
		DrawTriangleBetterBrute( uvCubePoints[6], uvCubePoints[7], uvCubePoints[4], 0xffff00ff, screenArray, SCREEN_SIZE, zBuffer, SCREEN_SIZE);
#pragma endregion
#pragma region Top face
...
#pragma region Front face
		...
		DrawTriangleBetterBrute(uvCubePoints[2], uvCubePoints[0], uvCubePoints[1], 0xffff00ff, screenArray, SCREEN_SIZE, zBuffer, SCREEN_SIZE);
...
#pragma region Bottom face
		...
		DrawTriangleBetterBrute( uvCubePoints[14], uvCubePoints[15], uvCubePoints[13], 0xffff00ff, screenArray, SCREEN_SIZE, zBuffer, SCREEN_SIZE);
#pragma endregion
#pragma region Left face
		ShaderCustomColor = 0xffff0000;
		DrawTriangleBetterBrute( uvCubePoints[17], uvCubePoints[18], uvCubePoints[16], 0xffff00ff, screenArray, SCREEN_SIZE, zBuffer, SCREEN_SIZE);
...
#pragma region Right face
		...
		DrawTriangleBetterBrute( uvCubePoints[21], uvCubePoints[22], uvCubePoints[20], 0xffff00ff, screenArray, SCREEN_SIZE, zBuffer, SCREEN_SIZE);

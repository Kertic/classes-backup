...
#pragma region Top face
		...
		DrawTriangleBetterBrute(cubePoints[1], cubePoints[2], cubePoints[5], 0xffff00ff, screenArray, SCREEN_SIZE, zBuffer, SCREEN_SIZE);
		DrawTriangleBetterBrute(cubePoints[5], cubePoints[6], cubePoints[2], 0xffff00ff, screenArray, SCREEN_SIZE, zBuffer, SCREEN_SIZE);
#pragma endregion
//#pragma region Front face
//		
...
//		DrawTriangleBetterBrute(cubePoints[0], cubePoints[3], cubePoints[4], 0xffff00ff, screenArray, SCREEN_SIZE, zBuffer, SCREEN_SIZE);
//		DrawTriangleBetterBrute(cubePoints[3], cubePoints[4], cubePoints[7], 0xffff00ff, screenArray, SCREEN_SIZE, zBuffer, SCREEN_SIZE);
//#pragma endregion
//#pragma region Left face
//		ShaderCustomColor = 0xffff0000;
//		DrawTriangleBetterBrute(cubePoints[0], cubePoints[1], cubePoints[4], 0xffff00ff, screenArray, SCREEN_SIZE, zBuffer, SCREEN_SIZE);
//		DrawTriangleBetterBrute(cubePoints[1], cubePoints[4], cubePoints[5], 0xffff00ff, screenArray, SCREEN_SIZE, zBuffer, SCREEN_SIZE);
//#pragma endregion
//#pragma region Right face
//		
//		ShaderCustomColor = 0xff00ff00;
//		DrawTriangleBetterBrute(cubePoints[2], cubePoints[3], cubePoints[6], 0xffff00ff, screenArray, SCREEN_SIZE, zBuffer, SCREEN_SIZE);
//		DrawTriangleBetterBrute(cubePoints[3], cubePoints[6], cubePoints[7], 0xffff00ff, screenArray, SCREEN_SIZE, zBuffer, SCREEN_SIZE);
//#pragma endregion
